              ...
              <div class="row">
                  ...
                  <div class="small-12 medium-9 columns">
                      ...
                      <div class="kk_aj_form_befintligutovare" rel="0">
                        <div class="row" >
                            <div class="large-8 columns">
                              <label>E-postadress<a href="#" class="arr_kk_aj_search_utovareEpost_info"> <i class="fa fa-question-circle" aria-hidden="true"></i></a></label>
                              <div class="arr_kk_aj_search_utovareEpost_infotext">Om du/ni varit med tidigare - ange e-postadress som aktör/utövare/grupp</div>
                        ...
                        <div class="row" >
                            <div class="large-8 columns">
                              <label>Ange postnummer<a href="#" class="arr_utovare_kk_aj_search_utovarePostnr_info"> <i class="fa fa-question-circle" aria-hidden="true"></i></a></label>
                                <div class="arr_kk_aj_search_utovarePostnr_infotext">Ange postnummer för aktör/utövare/grupp enligt exempel 142 42</div>
                                <input class="kk_aj_search_utovarePostnr" type="text" class="kk_aj_requireValidation" />
                    ...
                    <div class="kk_aj_form_utovareuppgifter">
                        ...
                        <div class="row" >
                            <div class="large-8 columns">
                              <label>Namn på utövare/aktör/grupp<a href="#" class="arr_utovare_aktor_grupp_info"> <i class="fa fa-question-circle" aria-hidden="true"></i></a></label>
                                <div class="arr_utovare_aktor_grupp_infotext">Fyll i namn på utövare/aktör/grupp som utför arrangemanget</div>
                        ...
                        <div class="row" >
                            <div class="large-8 columns">
                              <label>Utövare/aktör/grupp hemsida <a href="#" class="arr_utovare_orghemsida_info"> <i class="fa fa-question-circle" aria-hidden="true"></i></a></label>      
                                 <div class="arr_utovare_orghemsida_infotext">Ange ev URL till arrangemangets el utövaren-/aktören-/gruppens hemsida</div>
                        ...
                        <div class="row" >
                            <div class="large-8 columns">
                              <label>Adress<a href="#" class="arr_adress_info"> <i class="fa fa-question-circle" aria-hidden="true"></i></a></label>
                                <div class="arr_utovare_orghemsida_infotext">Ange adress för utövare/aktör/grupp</div>
                        ...
                        <div class="row" >
                            <div class="large-8 columns">
                              <label>Postnummer<a href="#" class="arr_utovare_postnummer_info"> <i class="fa fa-question-circle" aria-hidden="true"></i></a></label>
                                <div class="arr_postnummer_infotext">Ange postnummer för aktör/utövare/grupp enligt exempel 142 42</div>
                                <input id="utovare_postnummer" type="text" class="kk_aj_requireValidation_step1" />
                                <small class="error utovare_postnummer_error">Vänligen fyll i ett postnummer för utövare/aktör/grupp enligt exempel 142 42</small>                             
                            </div>                            
                        </div>
                        <div class="row" >
                            <div class="large-8 columns">
                        ...
                        <div class="row" >
                            <div class="large-8 columns">   
                                <fieldset class="utovareadressblock">
                                    ...
                                    <label>Telefonnummer<a href="#" class="arr_telefonnr_info"> <i class="fa fa-question-circle" aria-hidden="true"></i></a></label>
                                    <div class="arr_telefonnr_infotext">Ange kontaktpersonens telnr - INGA streck mellan siffror & telefonnummer</div>    
                                    <input id="utovare_telefonnr" type="text" class="kk_aj_requireValidation_step1" />
                                        <small class="error utovare_telefonnr_error">Vänligen fyll i kontaktpersonens telefonnummer - INGA streck mellan siffror & telefonnummer</small>                            
                            ...
                            <div class="large-8 columns"> 
                                <fieldset class="arrBeskrivning">
                                    ...
                                    <label>Rubrik<a href="#" class="arr_rubrik_info"> <i class="fa fa-question-circle" aria-hidden="true"></i></a></label>
                                        <div class="arr_rubrik_infotext">Fyll i en rubrik eller namn på arrangemanget</div>
                                    ...
                                    <label>Underrubrik<a href="#" class="arr_underrubrik_info"> <i class="fa fa-question-circle" aria-hidden="true"></i></a></label>
                                        <div class="arr_underrubrik_infotext">Fyll i en underrubrik för arrangemanget</div>
                                        <input id="arr_underrubrik" type="text" class="kk_aj_requireValidation_step2" rel="42"/>
                                        <small class="error arr_underrubrik_error">Vänligen fyll i en underrubrik för arrangemanget</small>  

                                    <label>Presentation<a href="#" class="arr_presentation_info"> <i class="fa fa-question-circle" aria-hidden="true"></i></a></label>
                                        <div class="arr_presentation_infotext">Fyll i en beskrivande text om arrangemanget. Försök att inte använda mer än 700 tecken.</div>
                                    ...
                                    <label>Antal medverkande<a href="#" class="arr_antalmedverkande_info"> <i class="fa fa-question-circle" aria-hidden="true"></i></a></label>
                                        <div class="arr_antalmedverkande_infotext">Fyll i antal medverkande på arrangemanget i siffror.</div>
                                        <input id="arr_antalmedverkande" rel="2" type="text" class="kk_aj_requireValidation_step2" class="kk_aj_Fakta" />
                                        <small class="error arr_underrubrik_error">Vänligen fyll i antal medverkande i siffror</small>

                                    <label>Lärarmaterial ingår<a href="#" class="arr_laromedel_info"> <i class="fa fa-question-circle" aria-hidden="true"></i></a></label>
                                      <div class="arr_laromedel_infotext">Välj om lärarmaterial ingår eller inte.</div>
                       ...
                       <!-- PressentationsBILD block START -->
                        <div class="row" >
                            <div class="large-8 columns">
                                 ...
                                 <fieldset class="arrpressentationbild">
                                    <legend>Presentationsbild<a href="#" class="arr_arrpressentationbild_info"> <i class="fa fa-question-circle" aria-hidden="true"></i></a></legend>
                                     <div class="arr_arrpressentationbild_infotext">Välj en bild som kommer att visas i din/er presentation. Fyll i alternativtext, filstorlek och fotograf och tryck sedan på knappen ladda upp.</div>
                                      <div class="row" >  
                                     ...
                                     <div class="row" >
                                        <div class="large-6 columns">
                                            <label>Alternativtext<a href="#" class="arr_altfoto_info"> <i class="fa fa-question-circle" aria-hidden="true"></i></a></label>
                                            <div class="arr_altfoto_infotext">Fyll i en alternativtext, dvs. en kort beskrivning av bilden</div>    
                                            <input id="arr_altfoto" type="text" rel="45"/>
                                                <small class="error arr_altfoto_error">Vänligen fyll i alternativtext</small>
                                        </div>
                                        <div class="large-6 columns">
                                            <label>Filstorlek<a href="#" class="arr_sizefoto_info"> <i class="fa fa-question-circle" aria-hidden="true"></i></a></label>
                                            <div class="arr_sizefoto_infotext">Fyll i hur stor bilden är ex. 2 MB</div> 
                                     ...
                                     <div class="row" >
                                        <div class="large-12 columns">
                                            <label>Fotograf<a href="#" class="arr_fotograf_info"> <i class="fa fa-question-circle" aria-hidden="true"></i></a></label>
                                            <div class="arr_fotograf_infotext">Fyll i namnet på fotografen som tagit bilden ovan.</div>
                        ...
                        <div class="row" >
                            <div class="large-8 columns">
                                <fieldset class="arr_lokal">
                                    <legend>Lokal</legend>                                       
                                    <label for="formBuildTimeId">Byggtid (min)<a href="#" class="arr_formBuildTimeId_info"> <i class="fa fa-question-circle" aria-hidden="true"></i></a></label>	
                                    <div class="arr_formBuildTimeId_infotext">Ange uppskattad byggtid i minuter, dvs föreställningens förberedelsetid.</div>			                    
                                    <input type="text" id="formBuildTimeId" name="formBuildTime" rel="10" value="" class="kk_aj_Fakta" >
                                    <small class="error arr_formBuildTimeId_error">Vänligen fyll i byggtid i minuter. Använd enbart siffror!</small>
                            
                                    <label for="formDemolishTimeId">Rivtid (min)<a href="#" class="arr_formDemolishTimeId_info"> <i class="fa fa-question-circle" aria-hidden="true"></i></a></label>
                                    <div class="arr_formDemolishTimeId_infotext">Ange uppskattad rivtid i minuter. Använd enbart siffror! </div>			                    
				                    <input type="text" id="formDemolishTimeId" name="formDemolishTime" rel="11" value="" class="kk_aj_Fakta" > 
                                    <small class="error arr_formDemolishTimeId_error">Vänligen fyll i rivtid i minuter. Använd enbart siffror!</small>              
 
                                    <label for="formVenueWidthId">Bredd på scen (meter)<a href="#" class="arr_formVenueWidthId_info"> <i class="fa fa-question-circle" aria-hidden="true"></i></a></label>
                                    <div class="arr_formVenueWidthId_infotext">Ange uppskattad bredd på scen i meter. Använd enbart siffror! </div>			                    
				                    <input type="text" id="formVenueWidthId" name="formVenueWidth" rel="12" value="" class="kk_aj_Fakta" >
				                    <small class="error formVenueWidthId_error">Vänligen ange bredd på scen i meter. Använd enbart siffror!</small>

                                    <label for="formVenueDepthId">Djup på scen (meter)<a href="#" class="arr_formVenueDepthId_info"> <i class="fa fa-question-circle" aria-hidden="true"></i></a></label>
                                    <div class="arr_formVenueDepthId_infotext">Ange vilket scendjup arrangemanget kräver i meter. Använd enbart siffror! </div>	
				                    <input type="text" id="formVenueDepthId" name="formVenueDepth" rel="13" value="" class="kk_aj_Fakta" >
                                    <small class="error arr_formVenueDepthId_error">Vänligen ange djup på scen i meter. Använd enbart siffror!</small>

				                    <label for="formVenueHeightId">Takhöjd över scen (meter)<a href="#" class="arr_formVenueHeightId_info"> <i class="fa fa-question-circle" aria-hidden="true"></i></a></label>	
                                    <div class="arr_formVenueHeightId_infotext">Ange vilken takhöjd arrangemanget kräver i meter. Använd enbart siffror! </div>				                    
                                    <input type="text" id="formVenueHeightId" name="formVenueHeight" rel="14" value="" class="kk_aj_Fakta">
                                    ...
                                    <label for="formVenueRequiermentsId" ><a href="#" class="arr_formVenueRequiermentsId_info"> <i class="fa fa-question-circle" aria-hidden="true"></i></a>Övriga lokalkrav</label>
                                    <div class="arr_formVenueRequiermentsId_infotext">Skriv kortfattat! ex rumstemperatur, golvmaterial, scen m.m.</div>			                    
                        ...
                        <div class="row" >
                            <div class="large-8 columns">
                                <fieldset class="arrpublik">
                                    ...
                                    <label id="labelMaxAudienceId" for="formMaxAudienceId">Max publik<a href="#" class="arr_labelMaxAudienceId_info"> <i class="fa fa-question-circle" aria-hidden="true"></i></a></label>
                                    <div class="arr_labelMaxAudienceId_infotext">Ange max antal personer i publiken. Skriv enbart siffror! </div>			                    
				                    <input type="text" id="labelMaxAudienceId" name="formMaxAudience" rel="6" value="" class="kk_aj_Fakta" >
                                     
                                    <label id="labelMaxParticipantsId" for="formMaxParticipantsId">Max antal deltagare<a href="#" class="arr_labelMaxParticipantsId_info"> <i class="fa fa-question-circle" aria-hidden="true"></i></a></label>
				                    <div class="arr_labelMaxParticipantsId_infotext">Ange max antal deltagare. Skriv enbart siffror! </div>			                    
                                    <input type="text" id="labelMaxParticipantsId" name="formMaxParticipants" rel="" value="" class="kk_aj_Fakta" >
                                     
                                    <label for="kk_aj_yearspan">Ålder:<a href="#" class="arr_kk_aj_yearspan_info"> <i class="fa fa-question-circle" aria-hidden="true"></i></a></label>
                                    <div class="arr_kk_aj_yearspan_infotext">Ange vilken lägsta och högsta åldern på målgruppen för arrangemanget är. </div>
                                    ...
                                    <label for="formMaxShowsId" id="labelMaxShowsId">Föreställningar per dag<a href="#" class="arr_formMaxShowsId_info"> <i class="fa fa-question-circle" aria-hidden="true"></i></a></label>
				                    <div class="arr_formMaxShowsId_infotext">Ange hur många föreställningar som kan ges per dag.</div>			                    
                                    <input type="text" id="formMaxShowsId" name="formMaxShows" rel="9" value="" class="kk_aj_Fakta" >
                                    
                                    <label for="kk_aj_speltid">Speltid (min):<a href="#" class="arr_kk_aj_speltid_info"> <i class="fa fa-question-circle" aria-hidden="true"></i></a></label>
                                    <div class="arr_kk_aj_speltid_infotext">Ange hur många minuter en föreställning av arrangemanget pågår</div>
                            ...
                            <div class="large-8 columns">
                                <fieldset class="arrpublik">
                                    <legend>Ekonomi</legend>                                                                            
                                     <label>Kostnad<a href="#" class="arr_ekonomikostnad_info"> <i class="fa fa-question-circle" aria-hidden="true"></i></a></label> 
                                        <div class="arr_ekonomikostnad_infotext">Pris för föreställningen i SEK (enbart siffror). För andra arrangemang använd fältet Övrigt nedan.</div>			                    
                                        <input id="arr_ekonomikostnad" type="text" class="kk_aj_Fakta"  rel="10" />
                                    ...
                                    <label>Övrigt<a href="#" class="arr_resorovrigt_info"> <i class="fa fa-question-circle" aria-hidden="true"></i></a></label>
                                    <div class="arr_resorovrigt_infotext">Ange övrigt om förutsättningar för resor kring arrangemanget. Resor - ex. Milersättning, anges i kr/mil, Logi - ex. 2 enkelrum eller 1 dubbelrum eller ex. allergiker eller rökare,  Traktamente - ex. - kr/dygn/person.</div>			                    
                                        <textarea id="arr_resorovrigt" rel="36"></textarea>
                        ...
                        <!-- Exempel block START -->                        
                         ...
                         <div class="row arrExempel" >
                            <div class="small-12  large-8 columns">                                
                                 <fieldset >               
                                     <legend>Lägg till Exempel<a href="#" class="arr_arrExempel_info"> <i class="fa fa-question-circle" aria-hidden="true"></i></a></legend>                    
                                      <div class="row addexempelblock" >                                           
                                        ...
                                        <div class="medium-4 columns">   
                                            ...
                                            <small class="error Exempelbild_error">Vänligen fyll i url</small>                                            
                                        </div>
