...
''' 
''' Because the control inherits from kk_aj_Publik_ArrangemangFormModuleBase you have access to any custom properties
''' defined there, as well as properties from DNN such as PortalId, ModuleId, TabId, UserId and many more.
''' 
''' </summary>
Public Class View
    Inherits kk_aj_Publik_ArrangemangFormModuleBase
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs) Handles Me.Load
        Try
            ...
            kk_aj_CurrentUserid.InnerHtml = UserId
