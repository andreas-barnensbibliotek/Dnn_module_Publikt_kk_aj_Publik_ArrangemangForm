...
' are accessible to your module's controls (that inherity from kk_aj_Publik_ArrangemangFormModuleBase
' 
' </summary>

Public Class kk_aj_Publik_ArrangemangFormSettingsBase
